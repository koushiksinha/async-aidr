...
public class NewTaggerJsonOutputAdapter {
	private static Logger logger = LoggerFactory.getLogger(NewTaggerJsonOutputAdapter.class);

	public NewTaggerJsonOutputAdapter() {
